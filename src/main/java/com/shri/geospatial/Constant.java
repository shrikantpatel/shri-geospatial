    ...
    final static String GEO_JSON_POLYGON = """
            {
                ...
                "coordinates": [
                    [
                        [-83.01053523842712, 39.971529237173456],\s
                        [-82.9778623546008 , 39.97534422736743 ],\s
                        [-82.97540187835695, 39.959819834275635],\s
                        [-82.98650264565369, 39.94859095665609 ],\s
                        [-83.01414012734313, 39.95955667858598 ],\s
                        [-83.01053523842712, 39.971529237173456] \s
                    ]
                ]
            }
    ...
    final static String GEO_JSON_MULTIPOINT = """
            {
                ...
                "coordinates": [
                    [
                        [-72.720566, 41.777841],\s
                        [-72.720566, 41.795376],\s
                        [-72.677822, 41.795376],\s
                        [-72.677822, 41.777841],\s
                        [-72.720566, 41.777841] \s
                    ]
                ]
            }
